...
typedef struct FieldingLogic {
    ...
    /* 0x90 */ u8 _pad1[0xAE - 0x90];
    /* 0xAE */ s16 unkAE;
    /* 0xB0 */ u8 _pad1a[0xBC - 0xB0];
    /* 0xBC */ s16 unkBC;
    /* 0xBE */ u8 _pad1aa[0xC4 - 0xBE];
    /* 0xC4 */ s16 unkC4;
    /* 0xC6 */ u8 _pad1b[0xF8 - 0xC6];
    /* 0xF8 */ u8 unk_F8[9];
    /* 0x101 */ u8 _pad1e[0x10C - 0x101];
    /* 0x10C */ u8 unk10C;
    /* 0x10D */ u8 unk10D;
...
typedef struct _WallBallPlayerSortInfo {
    /*0x00*/ u8 _00[0x28];
    /*0x28*/ u8 _28;
    /*0x29*/ u8 _29;
    /*0x2A*/ u8 _2A;
    /*0x2B*/ u8 _2B;
} WallBallPlayerSortInfo; // size: 0x2C

typedef union _WallBallSortInfoOverlay {
    MaybeWallBallStruct wallBallStruct;
    WallBallPlayerSortInfo wallBallPlayerSortInfo[4];
} WallBallSortInfoOverlay; // size: 0xB0
...
typedef struct MinigameProgressItem {
    u8 _pad0[0x1A];     // 0x00
    s16 field_0x1A;     // 0x1A
    u8 _pad1C[0xE];     // 0x1C to 0x29
    u8 field_0x2A;      // 0x2A
    u8 _pad2B[0xD];     // 0x2B to 0x37
} MinigameProgressItem; // Size: 0x38

typedef struct _MiniGameStruct {
    /*0x000*/ MinigameProgressItem progressItems[3];
    /*0x0A8*/ f32 _A8;
    /*0x0AC*/ f32 _AC;
    /*0x0B0*/ f32 _B0;
    /*0x0B4*/ f32 _B4;
    ...
    /*0x72A*/ u8 _72A;
    /*0x72B*/ u8 _72B;
    /*0x72C*/ WallBallSortInfoOverlay wallBallSortInfoOverlay;
    /*0x7DC*/ u8 _7DC;
    /*0x7DD*/ u8 _7DD;
    /*0x7DE*/ u8 _7DE;
    /*0x7DF*/ u8 _7DF;
...
typedef struct Fielder {
    /* 0x000 */ f32 pos[3];
    /* 0x00C */ u8 _pad_mid[0x8]; 
    /* 0x014 */ f32 prevPos[3];
    /* 0x020 */ u8 _pad_mid2[0x10];
    /* 0x030 */ f32 unk30;
    /* 0x034 */ f32 unk34;
    /* 0x038 */ u8 _pad_mid3[0x18];
    /* 0x050 */ f32 unk50;
    /* 0x054 */ f32 unk54;
    /* 0x058 */ u8 _pad_mid4[0x10]; 
    /* 0x068 */ f32 unk68;
    /* 0x06C */ u8 _pad1[0x1A4 - 0x6C];
    /* 0x1A4 */ s16 unk1A4;
    /* 0x1A6 */ u8 _pad1a[0x1AC - 0x1A6];
    /* 0x1AC */ s16 unk1AC;
    /* 0x1AE */ u8 _pad1b[0x1B6 - 0x1AE];
    /* 0x1B6 */ s16 unk1B6;
    /* 0x1B8 */ u8 _pad2[0x1C7 - 0x1B8];
    /* 0x1C7 */ u8 unk1C7;
    /* 0x1C8 */ u8 _pad3[0x1D3 - 0x1C8];
    /* 0x1D3 */ u8 unk1D3;
    /* 0x1D4 */ u8 _pad3a;
    /* 0x1D5 */ u8 unk1D5;
    /* 0x1D6 */ u8 unk1D6;
